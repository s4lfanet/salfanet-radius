...
export default function CollectorLoginPage() {
  ...
  return (
    <div className="min-h-dvh flex flex-col lg:flex-row bg-background">
      ...
      <div className="flex items-start justify-center w-full lg:w-[430px] lg:min-h-dvh bg-card border-r border-border shadow-xl px-4 pt-6 pb-6 sm:px-8 sm:pt-10 lg:pt-14 sm:pb-10 flex-shrink-0 relative">
        {/* Theme Toggle */}
        <button
          onClick={toggleTheme}
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-slate-100 via-white to-emerald-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-900 items-center justify-center px-12 py-8 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-40 h-40 sm:w-72 sm:h-72 bg-emerald-100/60 dark:bg-emerald-900/20 rounded-full blur-3xl pointer-events-none" />
