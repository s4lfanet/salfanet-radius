            ...
            <div className="flex items-center gap-3">
              {company.logo ? (
                <div className="w-12 h-12 rounded-lg bg-sidebar p-1 border border-brand-400/30 flex items-center justify-center overflow-hidden">
                  <Image unoptimized src={company.logo} alt={company.name || 'Logo'} width={48} height={48} className="max-w-full max-h-full w-auto h-auto object-contain" />
                </div>
              ) : (
  ...
  return (
    <div data-role="agent" className="min-h-dvh bg-background overflow-x-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none hidden dark:block">
        <div className="absolute top-0 left-1/4 w-48 h-48 sm:w-96 sm:h-96 bg-brand-500/10 rounded-full blur-3xl"></div>
        <div className="absolute top-1/3 right-1/4 w-48 h-48 sm:w-96 sm:h-96 bg-blue-500/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-1/2 w-48 h-48 sm:w-96 sm:h-96 bg-sky-500/10 rounded-full blur-3xl"></div>
