...
export default function PayManualPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  if (loading) {
    return (
      <div className="min-h-dvh bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center">
  ...
  return (
    <div className="min-h-dvh bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-gray-900 dark:to-gray-800 py-8 px-4">
