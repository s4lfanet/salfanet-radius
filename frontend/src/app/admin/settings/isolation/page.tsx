  ...
  return (
    <div className="bg-background relative">
      ...
      <div className="relative z-10 space-y-4">
        {/* Header */}
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-foreground dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-brand-500 dark:via-white dark:to-pink-500 dark:drop-shadow-[0_0_30px_rgba(6,182,212,0.5)] mb-1">
            <Shield className="w-6 h-6 text-brand-500 dark:text-brand-500 dark:drop-shadow-[0_0_20px_rgba(6,182,212,0.6)] inline mr-2" />
            {t('isolation.title')}
          </h1>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <input
                ...
                placeholder={settings.baseUrl ? `${settings.baseUrl.replace(/\/+$/, '')}/isolated` : 'https://radius.salfa.my.id/isolated'}
                className="w-full px-3 py-1.5 text-sm border border-border rounded-lg focus:ring-2 focus:ring-primary dark:bg-input dark:text-foreground"
              />
              <p className="text-[10px] text-muted-foreground mt-0.5">
