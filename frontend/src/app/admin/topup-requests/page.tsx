...
export default function TopUpRequestsPage() {
  ...
  return (
    <div className="bg-background relative">
      ...
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-xl sm:text-2xl font-bold text-foreground dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-brand-500 dark:via-white dark:to-pink-500 dark:drop- mb-2">{t('topup.requestsTitle')}</h1>
