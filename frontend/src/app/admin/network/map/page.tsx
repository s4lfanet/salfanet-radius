    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        ...
        <div className="text-center relative z-10">
          <Loader2 className="w-12 h-12 animate-spin text-brand-500 dark:text-brand-500 dark:drop- mx-auto mb-4" />
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-foreground dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-brand-500 dark:via-white dark:to-pink-500 dark:drop- flex items-center gap-3">
              <MapPin className="w-6 h-6 text-brand-500 drop-" />
              Network Map
            </h1>
        ...
        <div className="flex flex-wrap items-center gap-4 bg-card rounded-lg p-4 shadow-sm">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${showConnections
              ? 'bg-accent/20 text-accent dark:bg-purple-900/30 dark:text-primary'
              : 'bg-muted text-muted-foreground'
              }`}
          >
