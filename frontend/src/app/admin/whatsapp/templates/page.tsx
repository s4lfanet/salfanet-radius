      ...
      <div className="bg-card rounded-lg border border-border">
        <div className="px-3 sm:px-4 py-2.5 sm:py-3 border-b border-border">
          <div className="flex items-center justify-between gap-2 min-w-0">
            ...
            {template && (
              <span className={`px-1.5 sm:px-2 py-0.5 sm:py-1 text-[10px] sm:text-xs font-bold rounded shrink-0 border ${template.isActive ? 'bg-success/20 text-success border-success/40 ' : 'bg-muted/20 text-muted-foreground border-muted/40'}`}>
