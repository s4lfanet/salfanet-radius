    ...
    <div className="min-h-dvh bg-gradient-to-br from-slate-900 via-muted to-slate-900 relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-primary to-brand-500 rounded-2xl mb-5  border border-border">
            <Smartphone className="w-10 h-10 text-foreground" />
          </div>
          <h1 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-brand-500 via-white to-pink-500 drop-">
            {companyName}
          </h1>
        ...
        {/* 2FA Form */}
        <div className="bg-card dark:bg-gradient-to-br dark:from-slate-800/80 dark:to-slate-900/80 rounded-3xl border-2 border-border dark:border-border shadow-xl dark: p-8">
          {/* Info box */}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-primary dark:text-primary">
                ...
                <input
                  ...
                  placeholder="000 000"
                  className="w-full bg-background dark:bg-slate-900/80 border-2 border-border dark:border-border rounded-xl px-4 py-3.5 pl-12 text-foreground dark:text-white placeholder-muted-foreground dark:placeholder-slate-500 focus:border-primary dark:focus:border-brand-500 focus:outline-none dark:focus: transition-all text-2xl font-mono tracking-[0.5em] text-center"
                />
              </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-primary text-primary-foreground hover:bg-primary/90 font-bold py-3.5 rounded-xl transition-all duration-300 shadow-md dark:bg-gradient-to-r dark:from-primary dark:to-brand-500 dark:hover:from-[#d020ff] dark:hover:to-[#00d4dc] dark:text-white dark: dark:hover: disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
