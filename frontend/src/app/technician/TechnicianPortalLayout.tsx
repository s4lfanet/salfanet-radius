    ...
    <>
      ...
      <aside
        className={cn(
          ...
          'overflow-y-auto flex flex-col safe-area-inset-left',
      ...
      >
        ...
        {/* Navigation */}
        <nav aria-label="Main navigation" className="flex-1 px-3 py-1 space-y-0.5 overflow-y-auto">
          {MENU_ITEMS.map((item) => {
...
function TechnicianPortalInner({ children }: { children: React.ReactNode }) {
  ...
  if (loading) {
    return (
      <div data-role="technician" className="min-h-dvh bg-background flex items-center justify-center">
  ...
  return (
    <div data-role="technician" className="min-h-dvh bg-background overflow-x-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none hidden dark:block">
        <div className="absolute top-0 left-1/4 w-48 h-48 sm:w-96 sm:h-96 bg-brand-500/10 rounded-full blur-3xl" />
        <div className="absolute top-1/3 right-1/4 w-48 h-48 sm:w-96 sm:h-96 bg-blue-500/10 rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-1/2 w-48 h-48 sm:w-96 sm:h-96 bg-sky-500/10 rounded-full blur-3xl" />
