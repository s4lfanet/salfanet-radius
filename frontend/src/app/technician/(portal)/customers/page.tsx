...
const STATUS_CONFIG: Record<string, { dot: string; badge: string; icon: React.ReactNode }> = {
  ...
  stopped: {
    dot: 'bg-slate-400',
    badge: 'bg-muted/60 text-slate-600 dark:text-slate-400 border border-border/40',
    ...
    <div className="p-4 lg:p-6 space-y-4">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <button
          ...
          disabled={loading}
          className="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold bg-card hover:bg-accent text-muted-foreground border border-border rounded-xl transition-all shadow-sm"
        >
              ...
              return (
                <div key={c.id} className="p-3 space-y-2 hover:bg-slate-50 dark:hover:bg-[#bc13fe]/5 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-x-3 gap-y-1 text-[11px] ml-3.5">
                    ...
                    {c.expiredAt && (
                      <div className={`col-span-2 flex items-center gap-1 ${nearExpiry ? 'text-red-500 dark:text-red-400 font-semibold' : 'text-muted-foreground/70'}`}>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 whitespace-nowrap">
                          {c.expiredAt ? (
                            <div className={`flex items-center gap-1 text-[12px] ${nearExpiry ? 'text-red-500 dark:text-red-400 font-semibold' : 'text-muted-foreground/70'}`}>
                              <CalendarDays className="w-3 h-3 flex-shrink-0" />
