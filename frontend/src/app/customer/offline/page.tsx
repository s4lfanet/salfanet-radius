...
export default function CustomerOfflinePage() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-8rem)] px-6 py-12">
      ...
      <div className="relative mx-auto flex max-w-3xl flex-col items-center rounded-[32px] border border-cyan-400/20 bg-slate-950/80 px-8 py-12 text-center shadow-[0_30px_100px_rgba(6,182,212,0.14)]">
