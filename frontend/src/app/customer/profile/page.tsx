...
export default function CustomerProfilePage() {
  ...
  return (
    <div className="p-3 lg:p-6 space-y-3 w-full">
      {/* Profile Header */}
      <CyberCard className="p-6 bg-gradient-to-r from-primary/20 to-accent/20 border-2 border-primary/40 dark: shadow-sm">
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 rounded-full bg-primary/30 border-2 border-primary flex items-center justify-center ">
            <User size={32} className="text-primary drop-" />
          </div>
      ...
      {/* Package Information */}
      {customer.profile && (
        <CyberCard className="p-4 bg-card border-2 border-primary/30 dark: shadow-sm">
          <h2 className="text-sm font-bold text-primary mb-3 flex items-center gap-2 uppercase tracking-wider drop-">
            <Package size={16} className="drop-" />
