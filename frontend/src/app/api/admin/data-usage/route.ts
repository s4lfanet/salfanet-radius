...
// Proxy route for /api/admin/data-usage → /api/v1/data-usage
...
export async function GET(request: NextRequest) {
  return proxyToBackend(request, '/api/v1/data-usage');
}

export async function POST(request: NextRequest) {
  return proxyToBackend(request, '/api/v1/data-usage/aggregate');
}
