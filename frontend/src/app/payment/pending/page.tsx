...
function PaymentPendingContent() {
  ...
  if (error || !invoice) return (
    <div className="min-h-dvh bg-muted relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="relative z-10 max-w-sm w-full bg-muted/80 rounded-2xl border-2 border-red-500/50 p-6 text-center ">
        ...
        <button onClick={() => router.push('/')} className="px-6 py-2.5 text-xs font-bold bg-gradient-to-r from-primary to-brand-500 text-white rounded-xl">Kembali</button>
      </div>
    </div>
  );
  ...
  return (
    <div className="min-h-dvh bg-muted relative py-6 px-4">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/4 w-48 h-48 sm:w-96 sm:h-96 bg-pink-500/20 rounded-full blur-3xl"></div>
      ...
      <div className="max-w-md mx-auto space-y-4 relative z-10">
        <div className="text-center">
          <div className="inline-block relative mb-4">
            ...
            <div className="relative w-20 h-20 bg-gradient-to-br from-pink-500 to-primary rounded-full flex items-center justify-center mx-auto ">
        ...
        <div className="bg-muted/80 rounded-2xl border-2 border-pink-500/50 overflow-hidden ">
          <div className="bg-gradient-to-r from-pink-500 to-primary px-4 py-3">
          ...
          <div className="p-5 space-y-4">
            <div className="text-center py-5 bg-gradient-to-br from-pink-500/10 to-primary/10 rounded-xl border border-pink-500/20">
            ...
            {invoice.paymentLink && (
              <a href={invoice.paymentLink} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 w-full px-4 py-3 text-sm font-bold text-white bg-gradient-to-r from-primary to-brand-500 rounded-xl  hover: transition-all">
        ...
        <div className="space-y-2">
          <button onClick={() => { setChecking(true); fetchInvoiceStatus(); }} disabled={checking} className="w-full flex items-center justify-center gap-2 px-4 py-3 text-xs font-medium bg-card text-white rounded-xl border border-border hover:border-brand-500 disabled:opacity-50">
  ...
  return (
    <Suspense fallback={
      <div className="min-h-dvh bg-muted flex items-center justify-center">
        <Loader2 className="w-10 h-10 animate-spin text-brand-500 drop-" />
      </div>
    }>
