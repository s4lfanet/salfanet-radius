...
backup_configs() {
    ...
    if [ -f "/etc/nginx/sites-available/salfanet" ]; then
        cp /etc/nginx/sites-available/salfanet "$BACKUP_DIR/nginx-backup" 2>/dev/null || true
    fi
...
kill_port_processes() {
    ...
    local PORTS=(3000 3001 1812 1813 3799 1814)
