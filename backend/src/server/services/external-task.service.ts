...
export type TaskOperation =
  ...
  | 'sync_mikrotik_arp_create'
  | 'sync_mikrotik_arp_update'
  | 'sync_mikrotik_arp_delete'
  | 'sync_mikrotik_hotspot_create'
  | 'sync_mikrotik_hotspot_update'
  | 'sync_mikrotik_hotspot_delete'
  | 'send_wa'
  | 'send_email'
  | 'coa_disconnect'
  | 'reload_radius';
