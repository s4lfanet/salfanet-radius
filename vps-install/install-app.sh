...
generate_env() {
    ...
    # VPS_IP detected by common.sh (private/local IP preferred over public)
    # Used for: NEXTAUTH_URL, RADIUS_SERVER_IP, CORS, frontend URLs
    local vps_ip="${VPS_IP:-127.0.0.1}"
    print_info "Using VPS IP: $vps_ip"
...
EOF
    ...
    print_info "  NEXTAUTH_URL = http://${vps_ip}"
    print_info "  RADIUS_SERVER_IP = ${vps_ip}"
}
