...
echo ""
echo "  Services:"
echo "    Frontend:  http://localhost:${FRONTEND_PORT}  (PM2: salfanet-frontend)"
echo "    Backend:   http://localhost:${BACKEND_PORT}   (PM2: salfanet-backend)"
echo "    Nginx:     http://localhost:80"
$([ "$SKIP_FREERADIUS" = "false" ] && echo "    FreeRADIUS: active (ports 1812/udp, 1813/udp)")
echo ""
echo "  Next steps:"
echo "    1. Open http://YOUR_VPS_IP in browser"
echo "    2. Login with default admin credentials"
echo "    3. Configure RADIUS clients (NAS) in admin panel"
echo "    4. Create PPPoE profiles and IP pools"
echo ""
echo "  Logs:"
